...
async def header(pdf:FPDF):
    ...
    pdf.image("https://upload.wikimedia.org/wikipedia/commons/thumb/0/0f/Lambang_Kabupaten_Bandung%2C_Jawa_Barat%2C_Indonesia.svg/2458px-Lambang_Kabupaten_Bandung%2C_Jawa_Barat%2C_Indonesia.svg.png",w=30, h = 25, x=30, y=30)
    pdf.set_x(60)
